<x-layouts.layout>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-heading-1 mb-2">Edit Prediction</h1>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700 p-6 mb-8">
        <h2 class="text-heading-3 mb-4 text-blue-800 dark:text-blue-200">Current Prediction</h2>
    ...
    <x-mary-card class="p-6 mb-8">
        <h2 class="text-heading-3 mb-6">Update Prediction</h2>
    ...
    <x-mary-card class="p-6">
        <h2 class="text-heading-3 mb-4">Edit History</h2>
        <div class="space-y-4">
