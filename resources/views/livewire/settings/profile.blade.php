        ...
        <form wire:submit="updateProfileInformation" class="my-6 w-full space-y-6">
                ...
                @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail &&! auth()->user()->hasVerifiedEmail())
                    <div>
                        <p class="mt-4">
                            ...
                            <button class="text-sm cursor-pointer text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100" wire:click.prevent="resendVerificationNotification">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-end">
                    <x-mary-button type="submit" class="w-full justify-center">{{ __('Save') }}</x-mary-button>
                </div>
