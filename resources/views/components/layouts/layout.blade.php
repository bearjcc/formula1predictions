...
<body class="min-h-screen antialiased bg-white dark:bg-zinc-900 overflow-x-hidden">
    <div class="flex min-h-screen min-w-0">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700 flex flex-col transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out lg:sticky lg:top-0 lg:h-screen lg:shrink-0">
            <!-- App Logo/Title -->
            ...
            <nav class="flex-1 p-4 space-y-4 overflow-y-auto">
                <div>
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('news.index') }}" class="flex items-center space-x-2 px-3 py-2 rounded-lg text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 border-l-2 {{ request()->routeIs('news.*') ? 'bg-zinc-100 dark:bg-zinc-800 border-red-600 dark:border-red-500 text-red-600 dark:text-red-400 font-medium' : 'border-transparent' }}" wire:navigate>
