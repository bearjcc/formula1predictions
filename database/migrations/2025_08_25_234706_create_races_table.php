...
return new class extends Migration
{
    ...
    {
        // In some environments (e.g. long‑lived Railway databases) the `races`
        // table may already exist from an earlier migration. Guard the creation
        // so deploy-time `php artisan migrate` is idempotent and does not crash.
